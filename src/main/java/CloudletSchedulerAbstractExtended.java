 ...
 */
public abstract class CloudletSchedulerAbstractExtended implements CloudletScheduler {
    private static final Logger LOGGER = LoggerFactory.getLogger(CloudletSchedulerAbstractExtended.class.getSimpleName());
     ...
     */
    protected CloudletSchedulerAbstractExtended() {
        setPreviousTime(0.0);
        vm = Vm.NULL;
