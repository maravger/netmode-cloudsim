...
public class Plotter extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("n-MMC Evaluation");
        ...
        try (CSVReader dataReader = new CSVReader(new FileReader("/Users/avgr_m/netmode-cloudsim/evaluation_results/Prediction/(Wed Apr 01 20:48:12 EEST 2020)_P5_A0.csv"))) {
            String[] nextLine;
        ...
        stage2.setTitle("App Performance Evaluation (1/2)");
        ...
        try (CSVReader dataReader = new CSVReader(new FileReader("/Users/avgr_m/netmode-cloudsim/evaluation_results/AppPerformance/(Wed Apr 01 20:48:12 EEST 2020)_P5_A0.csv"))) {
            String[] nextLine;
            dataReader.skip(1); // Skip title
            while ((nextLine = dataReader.readNext()) != null) {
                String interval = nextLine[0];
        ...
        stage3.setTitle("App Performance Evaluation (2/2)");
        ...
        stage4.setTitle("POI Performance Evaluation (1/2)");
        ...
        try (CSVReader dataReader = new CSVReader(new FileReader("/Users/avgr_m/netmode-cloudsim/evaluation_results/PoiPerformance/(Wed Apr 01 20:48:12 EEST 2020)_P5.csv"))) {
            String[] nextLine;
            dataReader.skip(1); // Skip title
            while ((nextLine = dataReader.readNext()) != null) {
                String interval = nextLine[0];
        ...
        stage5.setTitle("POI Performance Evaluation (2/2)");
