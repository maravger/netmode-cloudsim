 ...
 */
public class DatacenterBrokerSimpleExtended extends DatacenterBrokerAbstractExtended {
    /**
     ...
     */
    public DatacenterBrokerSimpleExtended(final CloudSim simulation) {
        this(simulation, "");
    }
     ...
     */
    public DatacenterBrokerSimpleExtended(final CloudSim simulation, final String name) {
