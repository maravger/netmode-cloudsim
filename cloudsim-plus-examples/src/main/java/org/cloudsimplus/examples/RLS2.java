...
//        System.out.println(Arrays.toString(theta));
        ...
        double data1[][] = CSVUtils.readTo2dArray("/Users/avgr_m/Desktop/20/Vm0_@2017.09.01.17.18.18_100Samples.csv", true);
        double data2[][] = CSVUtils.readTo2dArray("/Users/avgr_m/Desktop/20/Vm0_@2017.09.01.17.18.18_100Samples.csv", true);
        RealMatrix rm = new Array2DRowRealMatrix(data1);
        RealMatrix rm2 = new Array2DRowRealMatrix(data2);
        double[] x1 = rm.getColumn(1);
        double[] x2 = rm2.getColumn(1);
//        double[][] u2 = {rm2.getColumn(4),rm2.getColumn(7)};
        double[] u2 = rm2.getColumn(7);
        double[] u1 = rm.getColumn(7);
//        double[][] u1 = {rm.getColumn(4),rm.getColumn(7)};
        System.out.println("BFR: " + computebfr(x1, x2, u1, u2) + "%");
